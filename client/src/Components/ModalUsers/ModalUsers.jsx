        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content bg-dark text-warning">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabelU">
                Modificar perfil - ID: {id}
              </h1>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div className="mb-3">
                    <label htmlFor="imageProfile" className="col-form-label">
                      Foto de perfil:
                    </label>
                    <input
                      type="file"
                      ...
                      id="imageProfile"
                      name="imageProfile"
                      value={updatedUserData.imageProfile}
                      onChange={handleChange}
                    />
                  </div>
                </div>
