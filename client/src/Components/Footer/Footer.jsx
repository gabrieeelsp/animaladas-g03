...
export default function Footer() {
  ...
  if (location.pathname === "/login" || location.pathname === "/admin" || location.pathname === "/register"  || location.pathname === "/detail/:id" || location.pathname === "/admin/forms" || location.pathname === "/add" || location.pathname === "/admin/reviews") {
    return null;
  }
