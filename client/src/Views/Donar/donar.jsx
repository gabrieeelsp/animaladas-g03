...
const Donar = () => {
  ...
  const handleCustomAmountClick = () => {
    ...
    if (!isNaN(amount) && amount >= 100) {
      ...
      document.getElementById("customAmountError").innerText = "El monto personalizado debe ser al menos de 100 pesos.";
    }
  };
          ...
          <div className="card-donar-body d-flex flex-column align-items-center">
            ...
            <div className="donar-options d-flex flex-wrap justify-content-center" style={{width:"90%"}}>
              ...
              <div className="donation-component-input-group mb-3 d-flex flex-column align-items-center">
                ...
                <p className="text-light small">El monto mínimo es de $100 ARS.</p>
              </div>
